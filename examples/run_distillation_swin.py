...
from models.swin_highway import SwinConfig, SwinHighwayForImageClassification_distillation
...
def main():
    ...
    model = SwinHighwayForImageClassification_distillation.from_pretrained(
        model_args.model_name_or_path,
