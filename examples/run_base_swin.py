...
from models.swin_highway import SwinConfig, SwinHighwayForImageClassification, SwinForImageClassification
...
class ModelArguments:
    ...
    loss_coefficient: float = field(
        default=0.6,
        metadata={
            "help": "the coefficient of the distillation loss"
        }
    )

    feature_loss_coefficient: float = field(
        default=0.04,
        metadata={
            "help": "the coefficient of the feature distillation loss"
        }
    )
...
def main():
    ...
    # trainer.add_callback(AddiWandbCallback)
